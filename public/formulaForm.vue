...
<!--        </svg>-->
  ...
  <!--            <div class="p-5 w-full bg-white flex shadow-lg justify-between items-center">-->
  <!--              <span class="text-4xl font-serif text-green-600 italic">Ajouter une formule</span>-->
  <!--            </div>-->
...
<!--            &lt;!&ndash; Confirmation d'envoi &ndash;&gt;-->
<!--            <div-->
<!--              ref="successMessage"-->
