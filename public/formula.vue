...
<!--                          <li class="px-4 py-2 hover:bg-gray-100 cursor-pointer text-red-500" @click="deletedFormula(formula.code)">Supprimer</li>-->
                        </ul>
                      </div>
                    </td>
...
// const deletedFormula = (code) => {
//   alert(`est tu sur de vouloir supprimer la formule ${code} ?`)
// };
