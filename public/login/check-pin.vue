...
<!--                stroke="#46aa4c"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round" class="text-black">-->
...
<!--          <span>D'ont have an account? <a href="#" class="pl-2 text-black  hover:text-green-500-->
